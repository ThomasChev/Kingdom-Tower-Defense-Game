...
cross_l = list(itertools.product(tile_x,tile_y))
dict_tile = dict.fromkeys(cross_l, 1)
dict_tile_fortress = dict_tile.copy()

# set available tiles to 0
cross_l = [(elem[0],elem[1]) for elem in tile_empty]
dict_tile2 = dict.fromkeys(cross_l, 0)
cross_l = [(elem[0],elem[1]) for elem in tile_empty_fortress]
dict_tile_fortress2 = dict.fromkeys(cross_l, 0)

# final tile dictionnaries
dict_tile.update(dict_tile2)
dict_tile_fortress.update(dict_tile_fortress2)
